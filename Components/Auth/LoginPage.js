          ...
          <div className="col-12 col-md-7">
            <div className=" p-2 px-sm-5">
              ...
              <div className="d-flex justify-content-center mt-3">
                ...
                >
                  {" "}
                  <span className="bi bi-google pe-2"></span> Login with google
                </button>
              </div>
              ...
              <form action="" ref={loginForm} onSubmit={handleSubmit(onSubmit)}>
                <div className="row m-0 w-100">
                  ...
                  <div className="col-12">
                    <div className="p-2">
                      <label className="form-label pe-3" htmlFor="type">
                        User Type:{" "}
                      </label>
              ...
              <div className="d-flex justify-content-center flex-column my-2">
                <p className="text-muted text-center">
                  Fotgot Password ?{" "}
                  <Link href="/login">
                    <a className="text-primary">Reset Password Now!</a>
                  </Link>
                </p>
                <p className="text-muted text-center">
                  Don't have Account ?{" "}
                  <Link href="/signup">
                    <a className="text-primary">Create New Account</a>
                  </Link>
                </p>
              </div>
            </div>
