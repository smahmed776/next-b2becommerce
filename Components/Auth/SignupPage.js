                ...
                <div className="row g-0 g-sm-3 m-0 w-100 p-0 p-sm-5 border rounded shadow bg-white">
                    ...
                    <div className="col-12 col-md-7">
                        <div className=" p-1 ps-sm-5 ">
                            {invalid.length> 0 && invalid.map(inv => (
                                <h6 className="text-danger">{`* ${inv}`}</h6>
                            )) 
                            }
                            {valid.length> 0 &&
                             <h6 className="text-success"><span className="bi bi-check-circle-fill text-success pe-2"></span>{valid}</h6> 
                            }
                            
                            <h6 ref={loginRef} className="text-success d-none"><span className="bi bi-box-arrow-in-right text-success pe-2"></span>You can <Link href="/login">Login</Link> now!</h6> 
                            
                            
                            <h5 className="p-2 text-center text-primary my-3">Create Your Account</h5>
                            <div className="col-12">
                                <div className="d-flex justify-content-center w-100 my-3">

                                    <button className={showMerchent ? "btn w-50 p-3 text-center border-bottom border-primary" : "btn w-50 p-3 text-center btn-primary"}
                                        ref={merchentbtn} data-bs-text="merchent" onClick={(e) => handleclick(e)} style={{ border: '0' }}>Sign Up as Marchent</button>
                                    <button className={showCustomer ? "btn w-50 p-3 text-center border-bottom border-primary" : "btn w-50 p-3 text-center btn-primary"}
                                        ref={customerbtn} data-bs-text="customer" onClick={(e) => handleclick(e)} style={{ border: '0' }}>Sign Up as Customer</button>
                                </div>
                            </div>
                            <Merchent show={showMerchent} invalidText={invalidText} setValid={setValid} login={loginRef} />
                            <Customer show={showCustomer} invalidText={invalidText} setValid={setValid} login={loginRef} />

                            <div className="d-flex justify-content-center flex-column my-2">
                                <p className="text-muted text-center">
                                    Already have Account ? <Link href="/login" ><a className="text-primary">Log in Now!</a></Link>
                                </p>
                            </div>
...
const Merchent = ({ show, invalidText, setValid, login }) => {
    ...
    return (
        <div className={show ? "d-block" : "d-none"}>
            <form action="" ref={marchentForm} onSubmit={handleSubmit(onSubmit)} className="needs-validation">
                <fieldset className="border">
                    ...
                    <div className="row m-0 w-100">
                        ...
                        <div className="col-12">
                            <div className="p-2">
                                <label className="form-label" htmlFor="companyname">User Name</label>
                                <input {...register("username")} type="text" id="username" className="form-control" required/>
                    ...
                    <div className="row m-0 w-100">
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-2">
                                ...
                                <input {...register("firstName")} type="text" id="Fname" className="form-control" required />
                        ...
                        <div className="col-12 col-sm-6">
                            <div className="p-2">
                                ...
                                <input {...register("lastName")} type="text" id="Lname" className="form-control" required />
                        ...
                        <div className="col-12">
                            <div className="p-2">
                                <label className="form-label" htmlFor="country">Country Name</label>
                    ...
                    <div className="row m-0 w-100">
                        ...
                        <div className="col-12">
                            <div className="p-2">
                                ...
                                <input {...register("companyName")} type="text" id="companyname" className="form-control" required />
                        ...
                        <div className="col-12">
                            <div className="p-2">
                                <label className="form-label" htmlFor="btype">Business Type</label>
                                <select {...register("businessType")} id="btype" className="form-select">
                ...
                <div className="row gy-3 m-0 w-100 p-2">
                    <div className="col-12">
                        <button ref={marchentSubmit} type="submit" className="btn btn-primary w-100">
                        <span className="spinner-border spinner-border-sm me-3 d-none" ref={marchentSpinner} role="status" aria-hidden="true"></span>
                            Sign Up
                        </button>
                    </div>
                </div>
    ...
    return (
        <div className={show ? "d-block" : "d-none"}>
            <form action="" ref={customerForm} onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="row gy-3 m-0 w-100 p-2">
                    <div className="col-12">
                        <button ref={customerSubmit} type="submit" className="btn btn-primary w-100">
                        <span className="spinner-border spinner-border-sm me-3 d-none" ref={customerSpinner} role="status" aria-hidden="true"></span>
                            Sign Up
                        </button>
                    </div>
                </div>
