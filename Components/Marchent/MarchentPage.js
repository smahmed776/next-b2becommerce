                    ...
                    <div className="cover position-relative">
                        ...
                        <div className="w-100 d-flex justify-content-center position-absolute" style={{ bottom: "-55px" }}>
                            <div className="rounded-pill p-2 bg-white" style={{ height: "120px", width: "120px", overflow: "hidden" }}>
                                ...
                                <img src="https://png.pngitem.com/pimgs/s/506-5067022_sweet-shap-profile-placeholder-hd-png-download.png"
                                    alt="" style={{
                                        height: "100%",
                                        width: "100%",
                                        objectFit: "cover",
                    ...
                    <div className=" d-flex flex-md-row flex-column justify-content-between pt-2 px-1 px-lg-4">
                        ...
                        <ul className="col-12 col-md-8 col-lg-7 col-xl-5 d-flex flex-wrap justify-content-evenly navbar-nav flex-row">
                            ...
                            <li className={
                                ...
                                <button ref={aboutbtn} onClick={() => history.push('/marchent/about')} data-bs-text="about" className="btn text-muted">About</button>
                            </li>
                            <li className={
                                ...
                                <button ref={productbtn} onClick={() => history.push('/marchent/product')} data-bs-text="product" className="btn text-muted">Product</button>
                            ...
                            <li className={
                                ...
                                <button ref={homebtn} onClick={() => history.push('/marchent/home')} data-bs-text="home" className="btn text-muted" >Home page</button>
                            </li>
                            <li className={
                                ...
                                <button ref={livebtn} onClick={() => history.push('/marchent/live')} data-bs-text="live" className="btn text-muted">Live Stream</button>
                            </li>
