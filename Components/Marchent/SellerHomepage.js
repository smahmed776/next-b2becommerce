...
const SellerHomepage = ({ show, data }) => {
  return (
        ...
        <div className="row row-cols-1 gy-5 m-0 w-100">
            ...
            <div className="border border-secondary bg-white p-2 p-md-5 rounded">
              <div className="px-0 px-lg-5">
                <Player
                  ...
                  poster={data?.home?.coverVideo?.thumbnail}
                >
                  <BigPlayButton position="center" />
                  <LoadingSpinner />
                  <ControlBar autoHide={true} />
                  <source src={data?.home?.coverVideo?.video} />
                </Player>
              </div>
            </div>
          </div>
          ...
          <div className="col">
            <div className="border bg-white rounded p-1 p-sm-5">
              <Slider slidesToShow={1} slidesToScroll={1} dots autoplay>
                {data?.home &&
                  data.home.mainImages.map((image) => (
                    <img
                      src={image}
                      alt=""
                      width="100%"
              ...
              <div className="col-12 col-lg-5 px-0 px-xl-3">
                ...
                <div className="my-2">
                  <img
                    src={clothcarousel.src}
                    alt=""
                    style={{ maxHeight: "305px", width: "100%" }}
                  />
                </div>
                <div className="my-2">
                  <img
                  ...
                  <div className="col">
                    <div className="border bg-light">
                      <img
                        src={shoeblack.src}
                        alt=""
                        style={{ maxHeight: "145px", width: "100%" }}
                      />
                    </div>
                  </div>
