      ...
      <div className="bg-primary">
        <div className="container d-flex flex-column justify-content-center align-items-center py-2 px-4">
          <div className="row row-cols-1 gy-3 justify-content-center align-items-center px-0 px-sm-5 my-4">
            ...
            <form action="#">
              <div
                className="col d-flex justify-content-center align-items-center px-0 mb-4 bg-white overflow-hidden subscribeInp"
                style={{ borderRadius: "2rem", height: "40px" }}
              >
                <input
                  type="email"
                  className="form-control rounded footer-input input-reset"
                  required
                />
