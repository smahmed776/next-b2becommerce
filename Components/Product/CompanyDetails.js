        ...
        <div className="row m-0 gx-1 gx-md-3 my-5 w-100">
            ...
            <div className="col-12 col-sm-7 ps-0">
                <div className="border rounded bg-white">
                    <div className="d-flex justify-content-start" style={{ marginTop: "-1.5rem" }}>

                        <button className="btn btn-secondary text-light cdetail-h6 p-2 ms-2" >Product Details</button>
                        <button className="btn btn-primary text-white cdetail-h6 p-2 ms-2" >Company Details</button>
                    </div>
                    ...
                    <div className="row row-cols-1 m-0 w-100 gy-2 p-3">
                        <div className="col border bg-light">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                ...
                                doloremque eveniet harum? Ex dolorum quod at quis quidem mollitia
                                incidunt quo. Molestiae, modi ipsum?</p>
                        ...
                        <div className="col py-3 px-2 px-xl-5">
                            <div className="row m-0 g-0 gy-2 gy-sm-0 justify-content-center">
                                <div className="col-12 col-sm-6 col-md-8 ">
                                    ...
                                    <input type="text" className="form-control d-block d-md-inline" style={{ borderBottomRightRadius: "0", borderTopRightRadius: "0" }} />
                                </div>
                                <div className="col-12 col-sm-6 col-md-4 px-5 px-sm-0">

                                    <button className="btn btn-primary" style={{ borderRadius: "0" }}>Ask Question</button>
                                </div>
                            </div>
                        </div>

                        <div className="col border bg-light">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae, quaerat eius provident optio,
                                nisi at quae sit modi commodi voluptatem molestiae,
                                adipisci perspiciatis doloribus excepturi tempora doloremque
                                libero eligendi quasi?</p>
                        </div>
                        <div className="col border bg-light">
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae, quaerat eius provident optio,
                                nisi at quae sit modi commodi voluptatem molestiae,
                        ...
                        <div className="col">
                            <div className="border shadow p-2">
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Tempora,
                                    a tempore magnam cum
                                    numquam quas perferendis repellat hic dolo

                                    res ipsam tenetur quibusdam fugit sint repellendus? Accusamus unde animi quos commodi.</p>
                            </div>
                        </div>
                        <div className="col">
                            <div className="border shadow p-2">
