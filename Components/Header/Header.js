...
const Header = ({children}) => {
    const [headerClass, setHeaderClass] = useState("container-fluid  bg-white border-bottom py-0 px-2 px-md-5 sticky-top")
    ...
    const makeSticky = () => {
        if (window.scrollY > window.innerHeight / 7 && window.scrollY < window.innerHeight / 2) {
            ...
            setHeaderClass("container-fluid  bg-white border-bottom py-0 px-2 px-md-5 makefixed")
            ...
            document.getElementById('fixedHeader').style.opacity = '1'
            setHeaderClass("container-fluid  bg-white border-bottom py-0 px-2 px-md-5 ")
        }
    }
    useEffect(() => {

        if (document !== 'undefined') { document.getElementById('fixedHeader').addEventListener('scroll', makeSticky) };
    }, [])
        ...
        <header>
                            ...
                            <div className="col">
                                ...
                                <ul className="navbar-nav flex-row justify-content-evenly w-100">
                                    <li className="nav-item">
                                        <Link href={header.path} passHref><a className="nav-link">{header.name}</a></Link>
                                    </li>
                                </ul>
                            </div>
                        ))}
            ...
            <div id="fixedHeader" className={headerClass}>
                <nav className="navbar navabar-light py-0">
                    ...
                    <button className="btn btn-transparent d-lg-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNav" aria-controls="offcanvasNav">
...
const NavOffcanvas = () => {
    return (
        ...
        <div className="offcanvas offcanvas-start d-lg-none bg-light" tabIndex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel">
            ...
            <div className="offcanvas-body justify-content-center align-items-center">
                ...
                <ul className="navbar-nav justify-content-center me-auto mb-2 mb-lg-0">
                            ...
                            <Link className="nav-link" href="/profile">
                                <div className="row m-0">
                                    <div className="col-2 m-0 ">
                                        <img className="d-inline rounded-pill" height="35px" width="35px" alt='' />
                                    </div>
                    ...
                    <button type="button" className="btn btn-secondary w-100 "> Log Out </button>
                </ul>
